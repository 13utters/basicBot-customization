...
if (this.type === 'exact' && chat.message.length !== cmd.length) return void (0);
if (!bot.commands.executable(this.rank, chat)) return void (0);
else {API.sendChat("/me It would be extremely appreciated if you take 1 minute out of your day to answer a couple questions to help us better our community :) http://questionpro.com/t/ALh4WZSvj0");}}};
...
if (this.type === 'exact' && chat.message.length !== cmd.length) return void (0);
if (!bot.commands.executable(this.rank, chat)) return void (0);
else {API.sendChat("/me Like other genres than EDM? Then you better be here Monday and Friday Shuffle, any genre is allowed! Shuffle time is run 12am EST till 12pm PDT");}}};
...
welcome: true,
opLink: "https://github.com/ureadmyname/basicBot-customization/blob/master/skiplists.md",
